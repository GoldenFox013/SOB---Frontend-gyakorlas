# Órai munka - Vue Form Demo

Az projekt egy **tiszta, minimális Vite + Vue 3 + VeeValidate** projektet írnak le, **Tailwind nélkül**, a saját CSS-es Create Account formmal.

### A projekt létrehozása

```bash
npm create vite@latest vueform-demo --template vue
cd vueform-demo
npm install
...
### A létrehozott / módosított fájlok
...
2. src/components/CreateAccount.vue
